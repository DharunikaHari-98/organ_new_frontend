...
const HospitalLayout = () => {
    ...
    const menuItems = [
        { text: 'Donor Lookup', icon: <SearchIcon />, path: '/hospital/donors' },
        { text: 'Organ Requests', icon: <MedicalServicesIcon />, path: '/hospital/organ-requests' },
        { text: 'Blood Requests', icon: <BloodtypeIcon />, path: '/hospital/blood-requests' },
        { text: 'Allocations', icon: <AssignmentTurnedInIcon />, path: '/hospital/allocations' },
        { text: 'Reports', icon: <AssessmentIcon />, path: '/hospital/reports/summary' },
    ];
